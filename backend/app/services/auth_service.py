...
from app.schemas import UserCreate, LoginRequest, VerifyCodeRequest, Verify2FARequest
from app.utils.encryption import encryption_manager
from app.utils.validators import validate_api_credentials, normalize_phone_number
...
class AuthService:
    ...
    async def start_login(self, db: Session, login_request: LoginRequest) -> dict:
        ...
        try:
            ...
            await telegram_service.send_code_request(
                login_request.api_id, 
                login_request.api_hash, 
                normalized_phone
            )
    ...
    async def register_user(self, db: Session, api_id: str, api_hash: str, phone_number: str) -> User:
