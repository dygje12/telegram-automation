...
from telethon.errors import (
    ...
    SlowModeWaitError, FloodWaitError, ChatWriteForbiddenError,
    UserBannedInChannelError, ChatAdminRequiredError, PeerIdInvalidError
)
...
class TelegramService:
    ...
    async def create_client(self, user_id: int, api_id: str, api_hash: str, session_data: str) -> bool:
    ...
    async def resolve_group(self, client: TelegramClient, group_input: str) -> Tuple[str, str, Optional[str]]:
        """
