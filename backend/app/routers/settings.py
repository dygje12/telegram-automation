...
from app.schemas import SettingsUpdate, SettingsResponse, MessageResponseGeneric
...
async def validate_settings(
    ...
    try:
        ...
        if settings.max_interval > 86400:  # More than 24 hours
            warnings.append("Very long intervals may reduce message sending frequency significantly")
        ...
        if interval_range < 600:  # Less than 10 minutes difference
            recommendations.append("Consider increasing the interval range for better randomization")
