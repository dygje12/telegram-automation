...
from app.schemas import BlacklistResponse, MessageResponseGeneric
...
async def remove_group_from_blacklist(
    ...
    try:
        ...
        if not success:
            return MessageResponseGeneric(
                message="Group was not in blacklist",
                success=True
            )
...
async def check_group_blacklist_status(
    ...
    try:
        ...
        if is_blacklisted:
            ...
            blacklist_entry = db.query(app.models.Blacklist).filter(
